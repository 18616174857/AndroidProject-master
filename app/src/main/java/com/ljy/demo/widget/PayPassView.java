...
public class PayPassView extends RelativeLayout {
    ...
    private void initView() {
        ...
        listNumber.add(10);
        listNumber.add(0);
        listNumber.add(R.mipmap.ic_pay_delgray);
                        ...
                        if (position == 11) {
                            switch (event.getAction()) {
                                case MotionEvent.ACTION_DOWN:
                                    holder.btnNumber.setBackgroundResource(R.mipmap.ic_pay_delwhite);
                                    break;
                                case MotionEvent.ACTION_MOVE:
                                    holder.btnNumber.setBackgroundResource(R.mipmap.ic_pay_delwhite);
                                    break;
                                case MotionEvent.ACTION_UP:
                                    holder.btnNumber.setBackgroundResource(R.mipmap.ic_pay_delgray);
                                    break;
                            }
                        }
                        return false;
